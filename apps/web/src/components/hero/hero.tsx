  ...
  return (
    <div className="container mt-52">
      <div className="relative">
        <section className="relative z-10 flex flex-col items-center justify-between gap-10 border-4 border-black bg-white px-10 py-10 shadow-md sm:flex-row sm:px-20">
          <div className="max-w-max font-heading md:block">
            <p className="text-3xl font-bold lg:text-4xl  xl:text-5xl">
              In a world of <span className="text-green">wannabes</span>,
              <br />
              <span className="text-blue">Woods</span>
              {` is the real deal"`}
            </p>
